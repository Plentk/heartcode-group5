...
export const metadata: Metadata = {
    title: "No Drugs pls | About Drugs",
            ...
            <div className="flex flex-col items-center py-6">
                ...
                <Carousel
                    ...
                    <CarouselContent className="flex flex-row">
                        ...
                        <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                            <Card className="p-1 bg-lime-300/90 dark:bg-lime-900/75">
                                <CardHeader className="font-bold text-2xl">
                                    Caffeine
                                </CardHeader>
                                <CardContent className="flex aspect-auto items-center justify-center">
                        ...
                        <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                            <Card className="p-1 bg-red-300/90 dark:bg-rose-900/75">
                                <CardHeader className="font-bold text-2xl">
                                    Cannabis
                                </CardHeader>
                                <CardContent className="flex aspect-auto items-center justify-center">
                        ...
                        <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                            <Card className="p-1 bg-orange-300/90 dark:bg-orange-900/75">
                                <CardHeader className="font-bold text-2xl">
                                    Tobacco
                                </CardHeader>
                                <CardContent className="flex aspect-auto items-center justify-center">
